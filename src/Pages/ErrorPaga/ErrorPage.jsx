...
const ErrorPage = () => {
    return (
        <div className='text-center items-center gap-4 '>
            ...
            <h1 className='font-bold text-3xl text-black'>Oops, page not found!</h1>
            <p className='font-sm text-sm p-4 text-gray-500'>The page you are looking for is not available.</p>
